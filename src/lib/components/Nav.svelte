...
<nav class="w-20 h-screen z-50 flex fixed top-0 left-0 bg-blue flex-col flex-nowrap">
    <img src="/emblem.webp" class="w-20 h-20 border-b border-white border-opacity-20" alt="Emblem">
    <button class="w-8 h-8 mx-auto mt-8 fill-white opacity-75 hover:opacity-100">
